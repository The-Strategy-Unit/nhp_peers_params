...
dat <- populate_table(skeleton_table, extracted_params, mitigator_lookup, mitigator_groups, nee)

# Heatmap-specific

sample_activity_params <- all_params$params |>
  report_params_table("activity_avoidance") |>
  dplyr::select(-c(time_profile, value_1, value_2, peer, baseline_year, horizon_year))
